...
var BaseCtl = /** @class */ (function () {
    ...
    BaseCtl.prototype.search1 = function () {
        console.log("search start");
        var _self = this;
        this.serviceLocator.httpService.post(_self.api.search + "/" + _self.form.pageNo, _self.form.searchParams, function (res) {
            if (res.success) {
...
module.exports = "<app-navbar></app-navbar>\n<style>\n   .fonts{\n    color: rgb(3, 3, 80);\n  }\n</style>\n<div class=\"content-wrapper\" style=\"padding-top: 3%;padding-bottom: 8%; background-image: url(../../assets/MyImages/purplee.jpg); background-repeat: no-repeat;\nbackground-attachment: fixed;\nbackground-size: cover;width:auto;\n  height: auto;\" >\n  <div class=\"container-fluid\">\n\n    <div class=\"panel panel-primary\">\n      <div class=\"panel-heading\" style=\"height: 50px;\">\n        <!-- <div class=\"col-sm-6 p-1 text-center\"> -->\n          <div class=\"text-center\">\n          <h1 class=\"fonts font-weight-bold\">{{'Marksheet List' | translate}}</h1>\n        </div>\n      </div>\n\n      <div class=\"row  pt-4 pb-4 \" style=\"margin-left:15%\">\n        <div class=\"col-sm-2\">\n         <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.name\" placeholder=\"{{'Search Name'| translate}}\">\n         <!-- <select class=\"form-control\" name=\"studentId\" [(ngModel)]=\"form.searchParams.studentId\" aria-label=\"ngSelected\">\n          <option [ngValue]=\"\" value=\"undefined\">{{' Select Name' | translate }}</option>\n          <option *ngFor=\"let obj of form.preload.studentList\" [value]=\"obj.key\">{{obj.value}}</option>\n        </select> -->\n        </div>\n        <div class=\"col-sm-2\">\n          <!-- <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.rollNo\" placeholder=\"{{'Search Roll No'| translate}}\"> -->\n          <select class=\"form-control\" name=\"id\" [(ngModel)]=\"form.searchParams.id\" aria-label=\"ngSelected\">\n            <option [ngValue]=\"\" value=\"undefined\">{{' Select RollNo.' | translate }}</option>\n            <option *ngFor=\"let obj of form.preload.rollNo\" [value]=\"obj.key\">{{obj.value}}</option>\n          </select>\n        </div>\n\n        <div class=\"col-sm-1 ml-3\">\n          <button (click)=\"submit()\" class=\"btn btn-primary\">\n            {{'Search'| translate}}</button>\n        </div>\n        <div class=\"col-lg-2 ml-4\">\n          <button (click)=\"forward('/marksheet')\" type=\"button\" class=\"btn btn-success\">{{'Add Marksheet'| translate}}\n          </button>\n        </div>\n        <div class=\"col-sm-1\">\n          <button (click)=\"deleteMany()\" class=\"btn btn-danger\">\n            {{'Delete'| translate}}</button>\n        </div>\n      </div>\n\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n        {{form.message}}\n      </div>\n      <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n        {{form.message}}\n      </div>\n     \n      <div class=\"p-1\">\n        <div class=\"table-responsive\">\n          <table class=\"table table-bordered table-striped table-hover\">\n            <thead class=\"thead-light text-uppercase\">\n              <tr>\n                <th><input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" name=\"list_name\" value=\"h1\" (change)=\"checkUncheckAll($event)\"/></th>\n                <th>{{'S.No'| translate}}</th>\n                <th>{{'RollNO'| translate}}</th>\n                <th>{{'Name'| translate}}</th>\n                <th>{{'Physics'| translate}}</th>\n                <th>{{'Chemistry'| translate}}</th>\n                <th>{{'Maths'| translate}}</th>\n                <th>{{'Edit' | translate}}</th>\n              </tr>\n            </thead>\n            <tbody>\n              <tr *ngFor=\"let m of form.list; let i = index\">\n                <!-- <td> <input type=\"checkbox\" name=\"list_name\" value=\"{{isMasterSel}}\" [(ngModel)]=\"isMasterSel\" (change)=\"isAllSelected()\"/>\n                  </td> -->\n                  <td> <input type=\"checkbox\"  #checkboxes  name=\"list_name\"  id=\"{{m.id}}\" value=\"{{isMasterSel}}\" (change)=\"checklistUpdate()\"/>\n                  </td>\n                <td> {{(form.pageNo*5)+i+ 1}} </td>\n                <td> {{ m.rollNo }} </td>\n                <td> {{ m.name }} </td>\n                <td> {{ m.physics }} </td>\n                <td> {{ m.chemistry }} </td>\n                <td> {{ m.maths }} </td>\n                <td>\n                  <a (click)=\"forward( '/marksheet/' +  m.id)\" style=\"cursor: pointer;\">\n                    <i class=\"fa fa-edit text-info\"></i>\n                  </a>\n                  \n                  <!-- <a (click)=\"delete(m.id)\" style=\"cursor: pointer;\">\n                    <i class=\"fa fa-trash text-danger\"></i>\n                  </a> -->\n                </td>\n                \n              </tr>\n            </tbody>\n          </table>\n          <table style=\"width: 100%;\">\n            <tr>\n              <td *ngIf = \"form.list.length<=5 && form.list.length>0\" style=\"width: 50%;\">\n          <button  (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\"> {{'Previous' | translate\n            }} </button></td>\n          <td *ngIf = \"form.list.length==0\" style=\"width: 50%; padding-left:50% ;\"><a class=\"btn btn-warning mr-1\" href=\"/marksheetlist\">{{'Back' | translate}}</a></td>\n\n            <td *ngIf = \"form.list.length<=5 && form.list.length>0\" style=\"padding-left:45% ;\"><button (click)=\"next()\" [disabled]=\"nextList==0\" type=\"button\" class=\"btn btn-info\"> {{'Next' |\n              translate }}</button></td>\n             <td><a class=\"btn btn-warning mr-1\" href=\"/marksheetlist\">Reset</a></td>\n             </tr>\n            </table>\n\n      </div>\n    \n    </div>\n\n  </div>\n</div>\n<app-footer></app-footer>\n"
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.logout = function () {
        ...
        //   localStorage.removeItem("loginId");
        //   localStorage.removeItem("role")
        //   console.log('After logout jsessionid---' +localStorage.getItem("JSESSIONID") + "  logout Veena Yadav");
        //   this.form.message = "Logout Successfully";
...
var StudentComponent = /** @class */ (function (_super) {
    ...
    StudentComponent.prototype.validateForm = function (form) {
        ...
        flag = flag && validator.isNotNullObject(form.collegeName);
        flag = flag && validator.isNotNullObject(form.phoneNo);
        flag = flag && validator.isNotNullObject(form.email);
        flag = flag && validator.isNotNullObject(form.dob);
        return flag;
